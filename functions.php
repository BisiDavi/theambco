...
function load_css()
{
    ...
    wp_register_style('whatsapp', get_template_directory_uri() . '/assets/css/whatsapp.css', array(), false, 'all');
...
function load_js()
{
    ...
    wp_enqueue_script('loader', get_template_directory_uri() . '/assets/js/loader.js', array(), '1.0.0', true);
